...
*Onde a coroa pesa mais que a própria morte.*  
*A lealdade exigida por ele transcende o túmulo e a sanidade.*

**Augúrios (Omens)**

1. Covas rasas em um cemitério antigo, todas abertas de dentro para fora. Não há pegadas se afastando, como se os mortos tivessem marchado em perfeita formação militar.  
2. O fantasma de um camponês chorando copiosamente. Ele repete sem parar que foi executado por traição apenas por olhar nos olhos do rei.  
3. Guardas esqueléticos em armaduras enferrujadas, parados em posição de sentido absoluto no meio da estrada. Eles não atacam a menos que alguém desrespeite a autoridade da coroa.  
4. Um bloco de execução gigantesco manchado de negro. Uma cabeça decepada (e morta há séculos) repousa sobre ele, ainda sussurrando os decretos paranoicos do Monarca.  
5. O som aterrador de uma maça de ferro colossal sendo arrastada lentamente contra o chão de pedra, ecoando pelas paredes da masmorra. O frio no ar congela a respiração.  
6. As portas de carvalho maciço do salão principal se despedaçam. Sentado em um trono de ossos e ouro manchado, o esqueleto gigante ergue sua coroa. *"Vocês ousam trazer o calor da vida à minha tumba?\!*
...
#### **As Criptas Condenadas (The Condemned Crypts)** *A loucura do Rei impregnou as pedras de seu domínio. Ao explorar as catacumbas reais, role 1d6 ao entrar em um corredor importante:*

| Dado | Evento da Cripta | Consequência |
| :---- | :---- | :---- |
| **1** | **Julgamento Fantasma** | Uma ilusão do Rei acusa um personagem de traição. Teste de SAB DC 12 ou o personagem ganha Condição: Aterrorizado (Desvantagem em ataques) até sair da sala. |
| **2** | **Piso Falso** | Ladrilhos que cedem sob o peso de armaduras pesadas. Teste de DES DC 13 ou cai em um fosso de ossos pontiagudos (1d6 de dano). |
| **3** | **Eco da Execução** | O som fantasmagórico de uma guilhotina. Todos no grupo perdem 1 Tocha de tempo de duração devido ao pânico momentâneo e desorientação. |
| **4** | **Tesouro Amaldiçoado** | Uma urna de ouro (150 PO). Tocar nela desperta 2 Guardas Reais Despertos escondidos nas sombras. |
| **5** | **Santuário Profanado** | Um altar a Zakarum destruído. Reconstruí-lo gasta 1 turno, mas abençoa as armas do grupo, causando \+1 de dano de Luz contra os mortos-vivos na cripta. |
| **6** | **Chuva de Ossos** | O teto treme e detritos caem. O grupo deve correr (Teste de FOR/DES DC 11\) ou sofre 1d4 de dano e fica coberto de poeira de túmulo, tossindo (dificulta furtividade). |

**O Tesouro da Tumba (Espólios do Rei Esqueleto)**  
Quando o Monarca Louco finalmente desmorona, seus ossos se transformam em pó brilhante, deixando para trás os tesouros de um reino há muito esquecido. Explorando o trono maldito, a Comitiva encontra **3d100 x 10 Peças de Ouro (PO)** antigas e pesadas, **1d6 Ametistas Lascadas** (valendo 50 PO cada) e uma relíquia real. Role 1d6:
