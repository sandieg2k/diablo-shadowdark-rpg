...
- Armaduras médias somam **DES até +2**
- Escudos agora são regra implícita pelo tipo de armadura da classe

### 📐 Padronização e Terminologia
- Todos os termos de distância padronizados: **Adjacente · Próximo · Distante**
- Tipos de dano canônicos: Físico, Fogo, Gelo, Relâmpago, Veneno, Necrótico, Radiante, Psíquico, Arcano
...
- **Apêndice B: Glossário** — todos os termos do sistema em um lugar só
